...
public class Task23 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Liczba zwierząt: " + zoo.getNumberOfAllAnimals());
        System.out.println("Zwierzęta: " + zoo.getAnimalsCount());
        System.out.println("Posortowane zwierzeta: " + zoo.getAnimalsCountSorted());
        zoo.addAnimals("LAMA", 5);
    }
}
